...
//
// Brand colors:
//   #006634  →  oklch(0.40 0.13 151)   Forest green
//   #282F99  →  oklch(0.37 0.17 268)   Deep indigo
//   #EA4E1B  →  oklch(0.62 0.21 33)    Vivid orange  ← primaryColor in seed
// ============================================================

export const mgrConstructionConfig = {
  company: {
...
export type MGRConstructionConfig = typeof mgrConstructionConfig;
